import os
from aggan_pytorch.aggan_pytorch import exists
import fire
import random
...
def run_training(rank, world_size, model_args, data, attn_data, load_from, new, num_train_steps, name, seed):
    is_main = rank == 0
    is_ddp = world_size > 1
...
def train_from_folder(
    ...
    if world_size == 1 or not multi_gpus:
        run_training(0, 1, model_args, data, attn_data, load_from, new, num_train_steps, name, seed)
        return
